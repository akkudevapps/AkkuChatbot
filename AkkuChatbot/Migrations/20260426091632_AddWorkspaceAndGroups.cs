...
{
    /// <inheritdoc />
    public partial class AddWorkspaceAndGroups : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspacePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionGroups_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentKind = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionGroupMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SessionGroupMembers_ChatSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "ChatSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionGroupMembers_SessionGroups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionGroupMembers_GroupId",
                table: "SessionGroupMembers",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionGroupMembers_SessionId",
                table: "SessionGroupMembers",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionGroups_UserId",
                table: "SessionGroups",
                column: "UserId");
        }
